...
const systemPrompts: Record<string, string> = {
    ...
    2.  No campo 'verses', encontre UM ÚNICO E PODEROSO versículo que garanta o perdão para o pecado confessado. Priorize versículos como 1 João 1:9, Salmos 103:12, ou Isaías 1:18.
    ...
    2. In the 'verses' field, find ONE SINGLE, POWERFUL verse that guarantees forgiveness for the confessed sin. Prioritize verses like 1 John 1:9, Psalm 103:12, or Isaiah 1:18.
